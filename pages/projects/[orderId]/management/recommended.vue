...
<template lang="pug">
.management__header
	p.subtitle(@click="viewResponse = !viewResponse") Отобразить отклики
p.subtitle.op5(v-if="!viewResponse") Нам не удалось найти кого-то подходящего, ожидайте откликов от специалистов
.management__responses(v-else)
	Response(viewEmployer)
</template>
