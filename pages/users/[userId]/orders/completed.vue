...
<template lang="pug">
Request(:info="PLACEHOLDER_REQUEST" isCompleted hasFeedback :isEmployer="typeVisitor === 'employer'")
Request(:info="PLACEHOLDER_REQUEST" isCompleted hasFeedback sentFeedback :isEmployer="typeVisitor === 'employer'")
Request(:info="PLACEHOLDER_REQUEST" isCompleted sentFeedback :isEmployer="typeVisitor === 'employer'")
</template>
